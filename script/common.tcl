...
set_msg_config -id {[Vivado 12-2489]} -string "-input_jitter" -new_severity INFO
...
set_msg_config -id {[Synth 8-3331]} -string "has unconnected port m_axi_" -new_severity INFO
set_msg_config -id {[Synth 8-3331]} -string "has unconnected port sw_i" -new_severity INFO
...
set_msg_config -id {[DRC DPIP-1]} -string "pipelining: DSP" -new_severity INFO
set_msg_config -id {[DRC DPOP-2]} -string "pipelining: DSP" -new_severity INFO
