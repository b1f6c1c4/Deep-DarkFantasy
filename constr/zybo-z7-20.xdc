...
#Buttons
set_property -dict { PACKAGE_PIN G11   IOSTANDARD LVCMOS33 } [get_ports { button_i[0] }]; #IO_L12N_T1_MRCC_35 Sch=btn[0]
set_property -dict { PACKAGE_PIN H12   IOSTANDARD LVCMOS33 } [get_ports { button_i[1] }]; #IO_L24N_T3_34 Sch=btn[1]
set_property -dict { PACKAGE_PIN G12   IOSTANDARD LVCMOS33 } [get_ports { button_i[2] }]; #IO_L10P_T1_AD11P_35 Sch=btn[2]
set_property -dict { PACKAGE_PIN H13   IOSTANDARD LVCMOS33 } [get_ports { button_i[3] }]; #IO_L7P_T1_34 Sch=btn[3]


#LEDs
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { led_o[0] }]; #IO_L23P_T3_35 Sch=led[0]
set_property -dict { PACKAGE_PIN H14   IOSTANDARD LVCMOS33 } [get_ports { led_o[1] }]; #IO_L23N_T3_35 Sch=led[1]
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { led_o[2] }]; #IO_0_35 Sch=led[2]
set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { led_o[3] }]; #IO_L3N_T0_DQS_AD1N_35 Sch=led[3]

set_property -dict { PACKAGE_PIN J13   IOSTANDARD LVCMOS33   PULLTYPE PULLUP } [get_ports { rot_ni[2] }]; #IO_L18N_T2_34 Sch=je[2]
set_property -dict { PACKAGE_PIN J14   IOSTANDARD LVCMOS33   PULLTYPE PULLUP } [get_ports { rot_ni[1] }]; #IO_25_35 Sch=je[3]
set_property -dict { PACKAGE_PIN H11   IOSTANDARD LVCMOS33   PULLTYPE PULLUP } [get_ports { rot_ni[0] }]; #IO_L19P_T3_35 Sch=je[4]

##RGB LED 5 (Zybo Z7-20 only)
#set_property -dict { PACKAGE_PIN Y11   IOSTANDARD LVCMOS33 } [get_ports { led5_o[2] }]; #IO_L18N_T2_13 Sch=led5_r
#set_property -dict { PACKAGE_PIN T5    IOSTANDARD LVCMOS33 } [get_ports { led5_o[1] }]; #IO_L19P_T3_13 Sch=led5_g
#set_property -dict { PACKAGE_PIN Y12   IOSTANDARD LVCMOS33 } [get_ports { led5_o[0] }]; #IO_L20P_T3_13 Sch=led5_b

##RGB LED 6
#set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { led6_o[2] }]; #IO_L18P_T2_34 Sch=led6_r
#set_property -dict { PACKAGE_PIN F17   IOSTANDARD LVCMOS33 } [get_ports { led6_o[1] }]; #IO_L6N_T0_VREF_35 Sch=led6_g
#set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { led6_o[0] }]; #IO_L8P_T1_AD10P_35 Sch=led6_b
...
set_property -dict { PACKAGE_PIN J11   IOSTANDARD LVCMOS33 } [get_ports { hdmi0_in_hpd_o }]; #IO_L22N_T3_34 Sch=hdmi_rx_hpd
set_property -dict { PACKAGE_PIN N13   IOSTANDARD LVCMOS33 } [get_ports { hdmi0_in_ddc_scl_io }]; #IO_L22P_T3_34 Sch=hdmi_rx_scl
set_property -dict { PACKAGE_PIN N14   IOSTANDARD LVCMOS33 } [get_ports { hdmi0_in_ddc_sda_io }]; #IO_L17N_T2_34 Sch=hdmi_rx_sda
set_property -dict { PACKAGE_PIN R13   IOSTANDARD LVCMOS33 } [get_ports { hdmi0_out_hpd_i }]; #IO_L5P_T0_AD9P_35 Sch=hdmi_tx_hpd

set_property -dict { PACKAGE_PIN P13   IOSTANDARD LVCMOS33 } [get_ports { hdmi1_in_hpd_o }]; #IO_L22N_T3_34 Sch=hdmi_rx_hpd
set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports { hdmi1_in_ddc_scl_io }]; #IO_L22P_T3_34 Sch=hdmi_rx_scl
set_property -dict { PACKAGE_PIN M9    IOSTANDARD LVCMOS33 } [get_ports { hdmi1_in_ddc_sda_io }]; #IO_L17N_T2_34 Sch=hdmi_rx_sda
set_property -dict { PACKAGE_PIN N9    IOSTANDARD LVCMOS33 } [get_ports { hdmi1_out_hpd_i }]; #IO_L5P_T0_AD9P_35 Sch=hdmi_tx_hpd

set_property -dict { PACKAGE_PIN M15   IOSTANDARD TMDS_33  } [get_ports { hdmi1_in_clk_n }]; #IO_L12N_T1_MRCC_34 Sch=hdmi_rx_clk_n
set_property -dict { PACKAGE_PIN L15   IOSTANDARD TMDS_33  } [get_ports { hdmi1_in_clk_p }]; #IO_L12P_T1_MRCC_34 Sch=hdmi_rx_clk_p
set_property -dict { PACKAGE_PIN M14   IOSTANDARD TMDS_33  } [get_ports { hdmi1_in_data_n[0] }]; #IO_L16N_T2_34 Sch=hdmi_rx_n[0]
set_property -dict { PACKAGE_PIN L14   IOSTANDARD TMDS_33  } [get_ports { hdmi1_in_data_p[0] }]; #IO_L16P_T2_34 Sch=hdmi_rx_p[0]
set_property -dict { PACKAGE_PIN L13   IOSTANDARD TMDS_33  } [get_ports { hdmi1_in_data_n[1] }]; #IO_L15N_T2_DQS_34 Sch=hdmi_rx_n[1]
set_property -dict { PACKAGE_PIN K13   IOSTANDARD TMDS_33  } [get_ports { hdmi1_in_data_p[1] }]; #IO_L15P_T2_DQS_34 Sch=hdmi_rx_p[1]
set_property -dict { PACKAGE_PIN K12   IOSTANDARD TMDS_33  } [get_ports { hdmi1_in_data_n[2] }]; #IO_L14N_T2_SRCC_34 Sch=hdmi_rx_n[2]
set_property -dict { PACKAGE_PIN K11   IOSTANDARD TMDS_33  } [get_ports { hdmi1_in_data_p[2] }]; #IO_L14P_T2_SRCC_34 Sch=hdmi_rx_p[2]
set_property -dict { PACKAGE_PIN M12   IOSTANDARD TMDS_33  } [get_ports { hdmi1_out_clk_n }]; #IO_L13N_T2_MRCC_35 Sch=hdmi_tx_clk_n
set_property -dict { PACKAGE_PIN L12   IOSTANDARD TMDS_33  } [get_ports { hdmi1_out_clk_p }]; #IO_L13P_T2_MRCC_35 Sch=hdmi_tx_clk_p
set_property -dict { PACKAGE_PIN N12   IOSTANDARD TMDS_33  } [get_ports { hdmi1_out_data_n[0] }]; #IO_L4N_T0_35 Sch=hdmi_tx_n[0]
set_property -dict { PACKAGE_PIN N11   IOSTANDARD TMDS_33  } [get_ports { hdmi1_out_data_p[0] }]; #IO_L4P_T0_35 Sch=hdmi_tx_p[0]
set_property -dict { PACKAGE_PIN R15   IOSTANDARD TMDS_33  } [get_ports { hdmi1_out_data_n[1] }]; #IO_L1N_T0_AD0N_35 Sch=hdmi_tx_n[1]
set_property -dict { PACKAGE_PIN P15   IOSTANDARD TMDS_33  } [get_ports { hdmi1_out_data_p[1] }]; #IO_L1P_T0_AD0P_35 Sch=hdmi_tx_p[1]
set_property -dict { PACKAGE_PIN R11   IOSTANDARD TMDS_33  } [get_ports { hdmi1_out_data_n[2] }]; #IO_L2N_T0_AD8N_35 Sch=hdmi_tx_n[2]
set_property -dict { PACKAGE_PIN P11   IOSTANDARD TMDS_33  } [get_ports { hdmi1_out_data_p[2] }]; #IO_L2P_T0_AD8P_35 Sch=hdmi_tx_p[2]

set_property -dict { PACKAGE_PIN E13   IOSTANDARD TMDS_33  } [get_ports { hdmi0_in_clk_n }]; #IO_L12N_T1_MRCC_34 Sch=hdmi_rx_clk_n
set_property -dict { PACKAGE_PIN F12   IOSTANDARD TMDS_33  } [get_ports { hdmi0_in_clk_p }]; #IO_L12P_T1_MRCC_34 Sch=hdmi_rx_clk_p
set_property -dict { PACKAGE_PIN E12   IOSTANDARD TMDS_33  } [get_ports { hdmi0_in_data_n[0] }]; #IO_L16N_T2_34 Sch=hdmi_rx_n[0]
set_property -dict { PACKAGE_PIN E11   IOSTANDARD TMDS_33  } [get_ports { hdmi0_in_data_p[0] }]; #IO_L16P_T2_34 Sch=hdmi_rx_p[0]
set_property -dict { PACKAGE_PIN F14   IOSTANDARD TMDS_33  } [get_ports { hdmi0_in_data_n[1] }]; #IO_L15N_T2_DQS_34 Sch=hdmi_rx_n[1]
set_property -dict { PACKAGE_PIN F13   IOSTANDARD TMDS_33  } [get_ports { hdmi0_in_data_p[1] }]; #IO_L15P_T2_DQS_34 Sch=hdmi_rx_p[1]
set_property -dict { PACKAGE_PIN F15   IOSTANDARD TMDS_33  } [get_ports { hdmi0_in_data_n[2] }]; #IO_L14N_T2_SRCC_34 Sch=hdmi_rx_n[2]
set_property -dict { PACKAGE_PIN G15   IOSTANDARD TMDS_33  } [get_ports { hdmi0_in_data_p[2] }]; #IO_L14P_T2_SRCC_34 Sch=hdmi_rx_p[2]
set_property -dict { PACKAGE_PIN M11   IOSTANDARD TMDS_33  } [get_ports { hdmi0_out_clk_n }]; #IO_L13N_T2_MRCC_35 Sch=hdmi_tx_clk_n
set_property -dict { PACKAGE_PIN M10   IOSTANDARD TMDS_33  } [get_ports { hdmi0_out_clk_p }]; #IO_L13P_T2_MRCC_35 Sch=hdmi_tx_clk_p
set_property -dict { PACKAGE_PIN N8    IOSTANDARD TMDS_33  } [get_ports { hdmi0_out_data_n[0] }]; #IO_L4N_T0_35 Sch=hdmi_tx_n[0]
set_property -dict { PACKAGE_PIN N7    IOSTANDARD TMDS_33  } [get_ports { hdmi0_out_data_p[0] }]; #IO_L4P_T0_35 Sch=hdmi_tx_p[0]
set_property -dict { PACKAGE_PIN P9    IOSTANDARD TMDS_33  } [get_ports { hdmi0_out_data_n[1] }]; #IO_L1N_T0_AD0N_35 Sch=hdmi_tx_n[1]
set_property -dict { PACKAGE_PIN P8    IOSTANDARD TMDS_33  } [get_ports { hdmi0_out_data_p[1] }]; #IO_L1P_T0_AD0P_35 Sch=hdmi_tx_p[1]
set_property -dict { PACKAGE_PIN R10   IOSTANDARD TMDS_33  } [get_ports { hdmi0_out_data_n[2] }]; #IO_L2N_T0_AD8N_35 Sch=hdmi_tx_n[2]
set_property -dict { PACKAGE_PIN P10   IOSTANDARD TMDS_33  } [get_ports { hdmi0_out_data_p[2] }]; #IO_L2P_T0_AD8P_35 Sch=hdmi_tx_p[2]
