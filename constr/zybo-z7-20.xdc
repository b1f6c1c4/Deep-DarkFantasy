...
#Switches
set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { sw_i[0] }]; #IO_L19N_T3_VREF_35 Sch=sw[0]
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { sw_i[1] }]; #IO_L24P_T3_34 Sch=sw[1]
set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 } [get_ports { sw_i[2] }]; #IO_L4N_T0_34 Sch=sw[2]
...
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33   PULLTYPE PULLUP } [get_ports { rot_ni[2] }]; #IO_L18N_T2_34 Sch=je[2]
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33   PULLTYPE PULLUP } [get_ports { rot_ni[1] }]; #IO_25_35 Sch=je[3]
set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33   PULLTYPE PULLUP } [get_ports { rot_ni[0] }]; #IO_L19P_T3_35 Sch=je[4]
